  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        number of patterns that the line could take. the pattern you have left
        (and hopefully, it will only be one) is that line's rhythm.
      </p>
      ...
      <p>
        ...
        much harder to implement, and so it is unlikely I will ever implement
        it. As a rule, modifications to how quantity is detected is not
        possible.
      </p>
      <p>
        It is also very difficult to deal with situations where a poet has
        broken the rules. The opening of Virgil's eclogue 1 is a good example of
        this, where the word "patriae" contains a long-short-long pattern that
        cannot be scanned.
      </p>
      <p>
        on the upside, however: this site is still under construction! I plan to
        add some other meters and a few other features as well.
      </p>
    </div>
  );
}
