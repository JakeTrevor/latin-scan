    ...
    <Route exact path="/about">
      <div className="aboutArea">
        ...
        <About title="What is Scansion?">
          ...
          to a small number of patterns that the line could take on. The pattern
        ...
        <About title="Usage">
          ...
          green box indicates a full scan. Clicking on a line in the output will
          allow you to see all the information about that line at once - you can
          select which version you want to diplay by clicking on it.
          ...
          vowel to make it short. This can be useful if the line isnt scanning
          right. On mobile, a "Go" button will be in the top right corner -
          press this to switch between the input and output.
        </About>
